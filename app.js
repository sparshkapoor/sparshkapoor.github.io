document.addEventListener("DOMContentLoaded", () => {
    ...
    getPlaylistTracks(playlistId).then(albumCovers => {
        ...
        albumCovers.slice(0, maxAlbums).forEach((cover, index) => {
            ...
            const initialFlipDelay = Math.random() * 3000; // Random initial delay up to 5 seconds

            // Start flipping a few albums at page load
            setTimeout(() => {
                flipCard.classList.add('flipped');
                setTimeout(() => flipCard.classList.remove('flipped'), 5000); // Stay flipped for 10 seconds
            ...
            function startContinuousFlip() {
                ...
                const flipDelay = Math.random() * (35000 - 10000) + 10000;
    ...
    // Smooth scroll to projects section when clicking the Projects button or arrow
    const projectsButtonContainer = document.getElementById("projects-button-container");
    projectsButtonContainer.addEventListener("click", () => {
